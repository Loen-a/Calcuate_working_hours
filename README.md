...
新版 PC 日历显示**杭州（浙江）**从今天起、含今天的 7 天预报，按杭州时间（UTC+8）对应日期。天气区位于日期格子右上方，使用 32px 彩色图标。宽格显示最低／最高摄氏温度、日均相对湿度和美标 AQI；较窄的格子显示图标和温度，悬停可查看湿度、AQI 和统计口径。过去日期和预报范围外不显示天气。手机和旧版界面保持原样。
