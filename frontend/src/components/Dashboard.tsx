...
export default function Dashboard({ data, summaryOnly = false }: { data: DashboardData; summaryOnly?: boolean }) {
  ...
  return (
    <section className={summaryOnly ? 'workhours-summary' : undefined} aria-label="工时统计">
      {!summaryOnly && <div className="workhours-forecast-card bg-surface border border-rule rounded-sm p-5 mb-3">
      ...
      <div className="workhours-summary-grid grid grid-cols-2 sm:grid-cols-4 gap-3">
