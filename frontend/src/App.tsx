...
export default function App() {
  ...
  return (
    <div className="workhours-app min-h-screen">
      ...
      <main className="workhours-content max-w-5xl mx-auto px-4 sm:px-8 py-8 sm:py-12" aria-busy={busy}>
        ...
        <div className="workhours-toolbar flex flex-wrap items-center justify-between gap-3 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {!desktop && <button disabled={busy} onClick={() => void navigate(data.selected_date, true)} className="border border-rule px-3 py-2 rounded-sm text-[13px] disabled:opacity-40">编辑所选日期</button>}
        ...
        <Dashboard data={data} summaryOnly={desktop} />
        ...
        {desktop ? <div className="workhours-workspace">
          <Calendar selected={data.selected_date} today={data.today} days={data.days} busy={busy} desktop onPick={date => void navigate(date)} />
        ...
        {desktop && <TrendChart days={data.days} desktop />}
